...
if __name__ == "__main__":
    ...
    evolution_times = [
        orig_data["time"][index],
        orig_data["time"][index] * 15,
        orig_data["time"][index] * 32,
        orig_data["time"][index] * 50.95,
    ]
    ...
    plots.plot_fidelity_time_fast_slow_specific_n(times_list, fidelities_list, gammas)
